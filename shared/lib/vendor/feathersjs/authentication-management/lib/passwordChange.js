...
module.exports = function passwordChange(
    options,
    identifyUser,
    oldPassword,
    password,
    ...
    return Promise.resolve()
        ...
        .then(function(user1) {
            return Promise.all([
                ...
                comparePasswords(oldPassword, user1.password, function() {
        ...
        .then(function(_ref) {
            ...
            return (
                // value from comparePassword is not needed
                patchUser(user1, {
    ...
    function patchUser(user1, patchToUser) {
        return users
            .patch(user1[usersIdName], patchToUser, {}) // needs users from closure
            .then(function() {
