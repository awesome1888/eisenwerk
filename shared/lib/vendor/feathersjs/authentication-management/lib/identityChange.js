...
module.exports = function identityChange(
    options,
    identifyUser,
    password,
    changesIdentifyUser,
    ...
    return Promise.resolve()
        ...
        .then(function(user1) {
            return Promise.all([
                ...
                comparePasswords(password, user1.password, function() {
                    return new errors.BadRequest('Password is incorrect.', {
                        errors: {
        ...
        .then(function(_ref) {
            ...
            var patchToUser = Object.assign({}, changesIdentifyUser || {});
